...
* **लाइफ का क्वालिटी**
    ...
    * **[obs-global-hotkeys](#obs-global-hotkeys)** — जीएनओएम (वेइलैंड और एक्सओआरजी) में ओब्स स्टूडियो के लिए ग्लोबल हॉटकीज़ इंस्टॉलर
    ...
    * **[wifi-show-password](#wifi-show-password)** — वर्तमान में कनेक्टेड वाईफ़ाई पासवर्ड को दिखाता है
* **उबेर स्क्रिप्ट**
...
**obs-global-hotkeys** जीएनओएम वातावरण (दोनों वेइलैंड और एक्सओआरजी) में ओब्स स्टूडियो के लिए वास्तविक ग्लोबल हॉटकीज़ की सेटअप को ऑटोमेट करता है, जिससे आम समस्या का समाधान होता है जहां ओब्स हॉटकीज़ केवल तब काम करते हैं जब एप्लिकेशन फ़ोकस में हो। यह सुरक्षित रूप से अनुकूलनीय कुंजी बाइंडिंग्स को इंस्टॉल करता है, जीएनओएम के मीडिया-कुंजी कॉन्फ़िगरेशन में उपलब्ध स्लॉट्स को बुद्धिमानी से खोजते हुए, मौजूदा उपयोगकर्ता-परिभाषित शॉर्टकट्स को ओवरराइट किए बिना। प्रक्रिया आइडेम्पोटेंट है - इसका अर्थ है कि दोहराए गए इंस्टॉलेशन प्रविष्टियों को दोहराएंगे नहीं - और स्वचालित रूप से दो डिफ़ॉल्ट हॉटकीज़ को कॉन्फ़िगर करता है: **Ctrl+F8** रिकॉर्डिंग टॉगल करने के लिए और **Ctrl+F9** पॉज़/यूनपॉज़ करने के लिए। स्क्रिप्ट चलाने से पहले, सुनिश्चित करें कि आपके पास `obs-cmd` (obs-cli पैकेज से) स्थापित है ताकि ओब्स को कमांड-लाइन से नियंत्रित करने की सुविधा मिल सके।

स्क्रिप्ट का उपयोग करने के लिए, हॉटकीज़ जोड़ने के लिए `./obs-global-hotkeys.sh install` या उन्हें साफ़ हटाने के लिए `./obs-global-hotkeys.sh uninstall` चलाएं। इंस्टॉलर गतिशील रूप से उपयोग न किए गए कुंजी बाइंडिंग स्लॉट्स (जैसे, `custom0`, `custom1`) को आरक्षित करता है, आपके मौजूदा जीएनओएम शॉर्टकट्स को संरक्षित रखते हुए ओब्स कार्यक्षमता जोड़ता है। यदि हॉटकीज़ इंस्टॉलेशन के तुरंत बाद सक्रिय नहीं होते हैं, तो एक्सओआरजी के लिए अल्ट+एफ2 > `r` के माध्यम से या वेइलैंड के लिए लॉग आउट/इन करके जीएनओएम शेल को रीस्टार्ट करें। अनइंस्टॉल कमांड केवल इस स्क्रिप्ट द्वारा बनाए गए बाइंडिंग्स को सटीक रूप से हटाता है, अन्य कस्टम कुंजी बाइंडिंग्स को छूता नहीं है। दोनों ऑपरेशन `gsettings` और `dconf` की आवश्यकता होती है, जो जीएनओएम में मानक हैं।
